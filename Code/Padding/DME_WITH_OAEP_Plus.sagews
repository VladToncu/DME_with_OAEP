...
#Generate a test plaintext and test the algorithm. This is where one can test the system to see if it works by comparing dec_p and test
test = "haa"
...
if(test == decrypt_pub):
    print "\nSuccess! Decrypted message is equal to original"
else:
    print "\nFail"
